    ...
    <div>
      ...
      <section className="home-values__container">
        <div className="home-values__card">
          ...
          <span className="home-values__card-svg"> <PassionateSVG /> </span>
          <div className="home-values__card-text-content">
        ...
        <div className="home-values__card m-lr-card">
          ...
          <span className="home-values__card-svg"> <ResourcefulSVG /> </span>
          <div className="home-values__card-text-content">
        ...
        <div className="home-values__card">
          ...
          <span className="home-values__card-svg"> <FriendlySVG /> </span>
          <div className="home-values__card-text-content">
